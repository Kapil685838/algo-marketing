<template>
  <div>
    <NuxtLink class="fixed bottom-0 right-5 top-description" to="#top-description">
      <svg height="50" width="50" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 51.9 53.5"
        style="enable-background:new 0 0 51.9 53.5;" xml:space="preserve">
