  ...
  state: () => ({
    ...
    service: {
      ...
      card: [
      {
        ...
        description:'We marinate strategies that best suit your business objectives by sprinkling the perfect salts of creativity and research.',
      },
      {
        id: 2,
        ...
        description:'We help you profitably define your marketing goals with our expertise in media planning and buying.',
      },
      {
        id: 3,
        ...
        label:'Analytics & SEO',
        description:'The P in Panga stands for performance and our SEO and Analytics team delivers it with appropriate insights that have the ability to transform your business.',
      },
      {
        id: 4,
        ...
        description:'When we say we give your brand a VOICE we mean – V : Versatile, O : Omnipotent, I : Impressional, C : Captivating, E : Empowered way of branding and communicating your business.',
      },
      {
        id: 5,
        ...
        description:'From the essential to the ornate, everything is taken care of completely, to offer a user-friendly interface and experience to your consumers.',
      },
      {
        id: 6,
        ...
        description:'To make your idea come to life, we dive into a pool of talent and find the right influencer(s) for the task in hand.',
      },
      {
        id: 7,
        ...
        description:'A perfect storyline is incomplete without the right set of shots taken from the perfect angles.',
      },
      {
        id: 8,
        ...
        description:'We do a thorough research and integrate industry insights with internet trends to give you the best advice.',
      },
      {
        id: 9,
        ...
        label:'Technology',
        description:'Only unrealistic aspect of us using technology is the experience we create for you outside our daily lives using the best of tech and tools.',
      },
